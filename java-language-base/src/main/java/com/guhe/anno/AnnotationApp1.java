...
//		a2();
//		a3();
		validateBean(new MyBean("111111", 20));
	}
	 ...
	 * 读取方法上的注解
	 */
	public static void a2() throws NoSuchMethodException, InstantiationException, IllegalAccessException {
